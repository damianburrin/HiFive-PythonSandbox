...
SCRIPT_ADDR = 0x20074000 # magic start address in flash of script
...
def hexlify_script(script):
    ...
    output = []
    addr = SCRIPT_ADDR
    assert(SCRIPT_ADDR >> 16 == 0x2007) # 0x2007 is hard coded in line below
    output.append(make_ihex_record(0, IHEX_TYPE_EXT_LIN_ADDR, b'\x20\x07'))
