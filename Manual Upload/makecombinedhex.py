...
def find_flash_python_line(hexfile):
    for i, line in enumerate(hexfile):
        if ':020000042007D3' in line:
            return i
    return None
...
if __name__ == '__main__':
    ...
    # print lines until flash python area or the start linear address record
    firmware_end = find_flash_python_line(firmware) or len(firmware) - 2
    ...
    print(":00000001FF", end='', file=args.output)
